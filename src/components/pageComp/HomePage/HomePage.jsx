        ...
        <div className='home-page page'>
            ...
            <div className='upper-info'>
                ...
                {props.fetched.startFilter &&
                    <Button onClick={clearFilterBtn} variant="contained" color="primary">לחץ בשביל לאפס את הסינון על עמודת {props.fetched.columnName}
                    </Button>}
            </div>
                    ...
                    <Table stickyHeader aria-label="sticky table">
                        ...
                        <TableBody>
                            {filteredRes.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((data) => {
                                return (
                                    <TableRow hover role="checkbox" tabIndex={-1} key={`row${data.id}`} onClick={() => moveToEdit(data)}>
