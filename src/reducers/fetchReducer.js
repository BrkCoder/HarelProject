...
const filteredRes = (state) => {
  ...
  switch (columnName) {
    ...
    case 'firstName':
    case 'phone':
      return filterFn.globalFilter(res, filterWay, columnName);
    case 'all':
      return filterFn.globalFilter(res, filterWay);
    case 'date':
      return filterFn.dateFilter(res, filterWay);
    case 'id':
      return filterFn.idFilter(res, filterWay);
    default:
      return res;
  }
};
